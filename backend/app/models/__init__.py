...
__all__ = [
    "Anotacao", "Cliente", "Contrato", "ConversaIA", "EmailCliente", "Feriado", "Honorario",
    "ItemReembolso", "Prazo", "Processo", "Publicacao", "Recebimento", "Reembolso",
    "Signatario", "Tarefa", "Tese",
]
