...
type Aba = 'dados' | 'timeline' | 'anotacoes' | 'emails' | 'processos' | 'financeiro' | 'contratos' | 'reunioes' | 'ia' | 'fiscal'
  ...
  return (
    <div>
      ...
      <div className={detailStyles.abas}>
        {(['dados', 'timeline', 'anotacoes', 'emails', 'processos', 'financeiro', 'contratos', 'reunioes', 'ia', 'fiscal'] as Aba[]).map((a) => (
          <button
            key={a}
